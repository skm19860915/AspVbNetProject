<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="GeneratorBeta.aspx.vb" Inherits="USDraftCo.GeneratorBeta" %>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group row mb-1">
                                <label class="col-sm-4 col-form-label-custom">Input Generator CFM:</label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group row mb-1">
                                <label class="col-sm-4 col-form-label-custom">Duct Drain:</label>
                                <div class="col-sm-5">
                                    <asp:TextBox ID="DDTxt" CssClass="form-control" runat="server">0</asp:TextBox>        
                                </div>
                                <div class="col-sm-3">
                                   <asp:RangeValidator ID="RangeValidator12" runat="server" 
                                        ControlToValidate="DDTxt" ErrorMessage="*" MaximumValue="10000" 
                                        MinimumValue="0" SetFocusOnError="True" Type="Integer" CssClass="style6"></asp:RangeValidator>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group row mb-1">
                                <label class="col-sm-4 col-form-label-custom">Bellows Joint:</label>
                                <div class="col-sm-5">
                                    <asp:TextBox ID="BJTxt" CssClass="form-control" runat="server">0</asp:TextBox>
                                </div>
                                <div class="col-sm-3">
                                    <asp:RangeValidator ID="RangeValidator13" runat="server" 
                                        ControlToValidate="BJTxt" ErrorMessage="*" MaximumValue="1000" MinimumValue="0" 
                                        SetFocusOnError="True" Type="Integer" CssClass="style6"></asp:RangeValidator>
                                </div>
                            </div>
                            <div class="form-group row mt-2">
                                <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group row mb-1">
                                <label class="col-sm-4 col-form-label-custom">JL&#39;s:</label>
                                <div class="col-sm-5">
                                    <asp:TextBox ID="JLTxt" CssClass="form-control" runat="server">0</asp:TextBox>
                                </div>
                                <div class="col-sm-3">
                                    <asp:RangeValidator ID="RangeValidator17" runat="server" 
                                        ControlToValidate="JLTxt" ErrorMessage="*" MaximumValue="1000" MinimumValue="0" 
                                        SetFocusOnError="True" Type="Integer" CssClass="style6"></asp:RangeValidator>
                                </div>
                            </div>
                            <div class="form-group row mb-1">
                            ...
                            <div class="form-group row mb-1">
                                <label class="col-sm-4 col-form-label-custom">Drain Section:</label>
                                <div class="col-sm-5">
                                    <asp:TextBox ID="DSTxt" CssClass="form-control" runat="server">0</asp:TextBox>
                                </div>
                                <div class="col-sm-3">
                                    <asp:RangeValidator ID="RangeValidator23" runat="server" 
                                        ControlToValidate="DSTxt" ErrorMessage="*" MaximumValue="10000" 
                                        MinimumValue="0" SetFocusOnError="True" Type="Integer" CssClass="style6"></asp:RangeValidator>
                                </div>
                            </div>
                            <div class="form-group row mb-1">
                                <label class="col-sm-4 col-form-label-custom">Barometric Damper:</label>
                                <div class="col-sm-5">
                                    <asp:TextBox ID="BDTxt" CssClass="form-control" runat="server">0</asp:TextBox>
                                </div>
                                <div class="col-sm-3">
                                    <asp:RangeValidator ID="RangeValidator24" runat="server" 
                                        ControlToValidate="BDTxt" ErrorMessage="*" MaximumValue="10000" 
                                        MinimumValue="0" SetFocusOnError="True" Type="Integer" CssClass="style6"></asp:RangeValidator>
                                </div>
                            </div>
                            <div class="form-group row mt-2">
